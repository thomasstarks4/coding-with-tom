  ...
  return (
    ...
    >
      <div className="text-center">
        <h2 className="text-2xl md:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-fuchsia-500">
          Choose Your Path
        </h2>
        ...
        {paths.map((path, idx) => {
          ...
          return (
            <motion.button
              ...
              className={`w-full text-left p-4 md:p-5 rounded-2xl border ${path.borderColor}/40 bg-gradient-to-r from-gray-800/80 to-gray-900/80 backdrop-blur-sm relative overflow-hidden group`}
            >
              {/* Hover glow */}
              ...
              <div className="relative flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className={`text-lg font-bold ${path.textColor} group-hover:brightness-125 transition-all`}>
                    {path.name}
                  </h3>
