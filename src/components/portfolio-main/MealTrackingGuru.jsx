      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8 text-center">
          ...
          <input
            ...
            className="text-center p-2 border-2 border-blue-800 shadow rounded focus:outline-none focus:ring-2 focus:ring-blue-400 hover:border-blue-400 hover:p-3 transition-all duration-300 text-black"
            min="0"
          />
        </div>
